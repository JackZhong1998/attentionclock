...
CONTENT = {
    "zh-Hant": {
        ...
        "why": [
            ...
            "**專注夥伴（可選）**：3000+ 像素角色，可下載、可浮窗常駐桌面",
            "**完全免費**：開源專案，程式碼公開",
        ],
        "pets_title": "專注夥伴（可選）",
        "pets_intro": "專注不必一個人硬撐。開啟專注夥伴後，可以：",
        "pets": [
    ...
    "es": {
        ...
        "pets_title": "Compañeros de enfoque (opcional)",
    ...
    "fr": {
        ...
        "pets_title": "Compagnons de focus (optionnel)",
    ...
    "de": {
        ...
        "pets_title": "Fokus-Begleiter (optional)",
        "pets_intro": "Fokussieren muss nicht einsam sein. Mit Fokus-Begleitern kannst du:",
        "pets": [
...
EN_FALLBACK = {
    ...
    "pets_title": "Focus companions (optional)",
    "pets_intro": "Focus doesn't have to feel lonely. With focus companions you can:",
    "pets": [
