...
CONTENT = {
    "zh-Hant": {
        ...
        "why": [
            ...
            "**桌面夥伴（可選）**：3000+ 像素角色，可下載、可浮窗常駐桌面",
            "**完全免費**：開源專案，程式碼公開",
        ],
        "pets_title": "桌面夥伴（可選）",
        "pets_intro": "專注不必一個人硬撐。開啟桌面夥伴後，可以：",
        "pets": [
            "**3000+ 像素圖鑑**：瀏覽、搜尋、下載喜歡的角色或 IP",
            "**專注時有回應**：夥伴陪在計時器旁，表情隨狀態變化",
    ...
    "es": {
        ...
        "pets_title": "Compañeros de escritorio (opcional)",
        "pets_intro": "Enfocarte no tiene que ser solitario. Con los compañeros de enfoque puedes:",
        "pets": [
        ...
        "install": [
            "Abre el archivo `.dmg`",
            "Doble clic en **Instalar y abrir**",
            "Si aparece «dañada», consulta la guía en el DMG",
        ],
    ...
    "fr": {
        ...
        "pets_title": "Compagnons de bureau (optionnel)",
        "pets_intro": "Se concentrer n'a pas à être solitaire. Avec les compagnons de focus :",
        "pets": [
        ...
        "install": [
            ...
            "Double-cliquez **Installer et ouvrir**",
            "Si « endommagée », voir le guide dans le DMG",
        ],
        "faq_title": "FAQ",
        "faq": [
    ...
    "de": {
        ...
        "pets_title": "Desktop-Begleiter (optional)",
        "pets_intro": "Fokussieren muss nicht einsam sein. Mit Desktop-Begleitern kannst du:",
        "pets": [
        ...
        "install": [
            "`.dmg` öffnen",
            "**Installieren und öffnen** doppelklicken",
            "Bei „beschädigt“ die Anleitung im DMG lesen",
        ],
        "faq_title": "FAQ",
        "faq": [
...
EN_FALLBACK = {
    ...
    "pets_title": "Desktop companions (optional)",
    "pets_intro": "Focus doesn't have to feel lonely. With desktop companions you can:",
    "pets": [
    ...
    "install": [
        "Open the `.dmg` file",
        "Double-click **Install and Open**",
        "If blocked, see **First Launch Guide.txt** in the DMG",
    ],
    "faq_title": "FAQ",
    "faq": [
